...
# CCTV geojson 구 별 분리
gdf = geopandas.read_file("https://github.com/rlawnstlr412/BigProject_10/blob/2b392206a5eb79221c737e76d4e43700028fd3a4/cctv.geojson")
...
cctv_info = pd.read_csv('https://github.com/rlawnstlr412/BigProject_10/blob/2b392206a5eb79221c737e76d4e43700028fd3a4/cctv_info.csv', encoding='cp949')
...
def show_map(lat, lon, zoom, data):
    ...
    df = pd.read_csv("https://github.com/rlawnstlr412/BigProject_10/blob/2b392206a5eb79221c737e76d4e43700028fd3a4/seoul_population.csv")
...
# -------------------------------------------------------------사이드바 설정(사진)-------------------------------------------------------------
with st.sidebar:
    seoul_logo = {"image_url" : "https://github.com/rlawnstlr412/BigProject_10/blob/2b392206a5eb79221c737e76d4e43700028fd3a4/seoul_img.png"}
